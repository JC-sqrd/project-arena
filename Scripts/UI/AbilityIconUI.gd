...
func initialize_ability_icon(ability_container : AbilityContainer):
	...
	if ability_container.ability != null and ability_container.ability.ability_icon_texture == null:
		...
		icon_texture_rect.texture = ability_icon_texture
...
func _on_ability_cooldown_start():
	...
	tween.tween_property(cooldown_progress_bar, "value", 0, ability.cooldown)
	pass
